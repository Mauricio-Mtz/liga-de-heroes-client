...
function RegisterPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-100px)] flex justify-center p-4">
      <div className="card w-full max-w-md min-h-[calc(100vh-100px)] bg-base-100 comic-border">
        <div className="card-body justify-between">
          <div className="text-center">
            <h1 className="text-4xl font-bold comic-title">¡Regístrate Ahora!</h1>
            ...
            <div className="flex flex-col">
              <label className="label cursor-pointer justify-start gap-2">
                ...
                <span className="label-text text-wrap text-justify">
                  Acepto los <Link to="/terms" className="link link-primary">Términos y Condiciones</Link> y la <Link to="/privacy" className="link link-primary">Política de Privacidad</Link>
                </span>
              </label>
            </div>
